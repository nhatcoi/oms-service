package com.nhatdev.ecommerce.email;

import com.nhatdev.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    @Async
    public void sentPaymentSuccessMail(
        ...
        messageHelper.setFrom("vnhat.dev@gmail.com");
        ...
        try {
            ...
            log.info(String.format("INFO - Email successfully snet to %s", destinationEmail));
        } catch (MessagingException e) {
            log.warn("WARN - Error while sending email to {}: {}", destinationEmail, e.getMessage());
        }
